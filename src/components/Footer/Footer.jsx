                ...
                <div >
                    <div className="p-5 col-span-4 text-center ">
                        <div className="flex justify-center mb-3">
                            ...
                            <a className="text-3xl font-bold font-montserrat flex items-center"> Stay<span className=' text-[#90B0B7]'>Sage</span></a>
                        </div>
                        <p className=" text-sm font-poppins mb-3">Discover luxurious accommodations and exclusive offers. Stay updated with our newsletter. Connect with us on social media. <br /> Book your dream vacation now and embark on an unforgettable journey with us!</p>
                    </div>
                </div>
                <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-3 sm:grid-cols-2 mx-auto">
                    <div className="p-5">
                        <div className="text-sm uppercase text-[#90B0B7] font-bold">Explore Destinations</div>
                        <a className="my-3 block" href="/#">Discover Our StaySage <span className="text-teal-600 text-xs p-1"></span></a>
                    ...
                    <div className="p-5">
                        <div className="text-sm uppercase text-[#90B0B7] font-bold">Connect with Us</div>
                    ...
                    <div className="p-5">
                        <div className="text-sm uppercase text-[#90B0B7] font-bold">About Us</div>
